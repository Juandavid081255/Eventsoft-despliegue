...
# IMPORTANTE: NO uses DEFAULT_FILE_STORAGE aquí
# Los CloudinaryField manejan su propio almacenamiento automáticamente
# Solo queremos usar Cloudinary para los campos CloudinaryField, no para TODO
